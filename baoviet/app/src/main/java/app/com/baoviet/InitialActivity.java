...
public class InitialActivity extends AppCompatActivity implements AsyncResponse, DialogEventListener {
        ...
        if (isClickOk) {
            switch (actionDialog) {
                ...
                case Constant.ACTION_DIALOG_CHANGE_PASSWORD:
                    ...
                    bundle.putString(Keys.KEY_USER_CODE, SaveSharedPreference.getUserName(this));
                    bundle.putString(Keys.KEY_OLD_PASSWORD, SaveSharedPreference.getPassword(this));
//                    bundle.putSerializable(Keys.KEY_USER_LOGIN, userResult);
                    Intent intent = new Intent(getApplicationContext(), MainActivity.class);
                    //Add the bundle to the intent
                    intent.putExtras(bundle);
